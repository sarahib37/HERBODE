...
export default function Difference({}: Props) {
  return (
    <Box bg='#efe6c8' py={{ base: 10, md: 16 }}>
        ...
        <Button bg='#f34418' color='white' display='block' mx='auto'mt={{ base: 6, md: 10 }} px={{ base: 6, sm: 8 }} fontSize={{ base: "md", sm: "lg", md: "1.15em" }}fontWeight='bold' boxShadow='lg' _hover={{'color':'#f34418', 'bg':'#efe6c8'}} borderRadius='2xl'>Donate Here</Button>
    </Box>
  )
}